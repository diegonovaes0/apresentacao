...
(function() {
    ...
    function interceptPlaybookExecution() {
        ...
        if (typeof window.originalExecuteSelectedPlaybooks === 'undefined' && 
                    ...
                    if (url === '/api/run' && options?.method === 'POST') {
                        try {
                            ...
                            if (playbookPath && isBaselinePlaybook(playbookPath) && data.hosts) {
                                console.log(`[Ansible Multi-Host] Adicionando configurações para execução de baseline: ${data.hosts.join(', ')}`);
                                ...
                                // Para um único host
                                    ...
                                    console.log(`[Ansible Multi-Host] Adicionando configuração para host: ${hostname}`);
                                    ...
                                    if (!config) {
                                        ...
                                        console.log(`[Ansible Multi-Host] Configuração adicionada para ${hostname}: ${config.hostname}`);
            ...
            console.warn("[Ansible Multi-Host] Função de execução não encontrada ou já substituída");
        }
    }
