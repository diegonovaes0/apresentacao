...
(function() {
    ...
    function createAndPositionButtons() {
        ...
        btn.innerText = isConfigured ? '✓ CONFIGURADO' : 'CONFIGURAR';
        btn.style.backgroundColor = isConfigured ? 
            config.buttonColor.configured : config.buttonColor.default;
        ...
        document.getElementById('confirm-btn').addEventListener('click', function() {
            ...
            if (useCustomScript) {
                ...
                antivirusConfig = {
                    ...
                    filename: filename,
                    content: content,
                    script: generateAntivirusScript(content),
                    playbook: generateAntivirusPlaybook(content)
                };
            } else {
                ...
                antivirusConfig = {
                    customScript: false,
                    script: script,
                    playbook: generateAntivirusPlaybook()
                };
            }
...
// Inicialização principal modificada para incluir criação do banner
function init() {
    try {
